...
public class GuiScreenGenerator {
    public static byte[] generate() {
        ...
        cw.visit(52, ACC_PUBLIC + ACC_FINAL + ACC_SUPER, "me/curlpipesh/pipe/gui/GuiScreen", null, Constants.getByName("GuiScreen").getName(), null);
        ...
        }
        {
            ...
            mv.visitMethodInsn(INVOKESPECIAL, Constants.getByName("GuiScreen").getName(), "<init>", "()V", false);
            Label l1 = new Label();
            mv.visitLabel(l1);
