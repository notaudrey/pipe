...
public abstract class Widget extends Taggable implements IWidget {
     ...
     * just a plain-old {@link java.lang.String} so that it can be used in a
    ...
    /**
     * Returns a {@link java.awt.Point} containing the current x- and
     * y-coordinates of the mouse cursor, scaled to work with Minecraft's GUI
     * scaling. Originally written by DarkStorm_.
     *
     * @return A {@link java.awt.Point} containing x- and y-coordinates of the
     *         mouse cursor.
     */
