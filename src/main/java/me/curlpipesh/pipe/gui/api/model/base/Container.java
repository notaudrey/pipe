...
public abstract class Container extends Widget implements IContainer {
     ...
     * to be added to this container. If this {@link java.util.List} is empty,
     ...
     * children. This list is a {@link java.util.concurrent.CopyOnWriteArrayList}
    ...
    /**
     * A {@link java.util.List} of all the {@link Widget}s that are the
